        ...
        <Card pad={0} style={{ marginBottom: 18, overflow: "hidden",
          ...
          <div style={{ padding: "20px 22px 18px",
            ...
            {[
              ...
              { n: 2, done: false,
                title: "Run your first workout",
                blurb: "Live sessions are paused while the process is rebuilt. Train on your own: pick a few verses, drill them, quiz yourself.",
                cta: "Start training", go: "scripturegym" },
              { n: 3, done: false,
